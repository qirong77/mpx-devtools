...
function findParentComponent(instance) {
    ...
    // 4. 通过小程序原生关系查找
    if (instance.getRelationNodes && typeof instance.getRelationNodes === "function") {
        try {
...
function findChildrenComponent(instance) {
    ...
    // 1. 直接从实例上获取已存储的子组件
    if (instance.mpxDevToolsChildren && Array.isArray(instance.mpxDevToolsChildren)) {
    ...
    if (instance.selectAllComponents && typeof instance.selectAllComponents === "function") {
        try {
    ...
    if (instance.selectComponent && typeof instance.selectComponent === "function") {
        try {
            // 尝试查找常见的子组件选择器
